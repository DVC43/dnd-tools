...
window.BACKSTORY_DATA = {
    ...
    CREATOR_POOLS: {
        ...
        mortal: [
            ...
            },
            {
                ...
                extraSentences: [
                    "The work was revised repeatedly as new insights emerged.",
    ...
    CREATOR_FALLBACK_SENTENCES: {
        good: {
            ...
            nonlawful: [
                "The work reflects choices made quickly, and justified only afterward.",
                "Not everyone agreed the outcome justified the process, even when the intent was kind.",
            ],
        },
        evil: {
            lawful: [
    ...
    PROVENANCE_DETAILS: {
        uncommon: {
            good: [
                ...
                "The maker discouraged attention, preferring the work to speak quietly for itself.",
    ...
    CREATOR_ALIGNMENT_ENDINGS: {
        good: {
            lawful: [
                ...
                "guided by the belief that structure was the surest defense against harm",
            ],
            nonlawful: [
                "known for letting conscience outrank tradition",
                "known for compassion that outran custom",
                "recognized for choosing mercy over approval",
                ...
                "known for answering need before permission",
            ],
        },

        evil: {
            lawful: [
                "known for methods that were precise, contractual, and unforgiving",
                "known for a belief that control was simply another form of responsibility",
                "known for treating authority as a tool rather than a duty",
                "guided by rules designed to favor their position",
                "known for valuing obedience as proof of correctness",
                "known for enforcing order without regard for consent",
                "guided by the belief that structure existed to be exploited, not shared",
                "known for viewing compliance as a moral good in itself",
            ],
            nonlawful: [
                "driven by ambition with little concern for consequence",
                "guided by appetite rather than restraint",
                ...
                "known for valuing outcome over method and survival over loyalty",
        ...
        neutral: {
            chaotic: [
                "inclined to let priorities shift as easily as circumstance allowed",
                ...
                "known for valuing flexibility over planning",
            ...
            nonchaotic: [
                ...
                "known for valuing predictability when creativity offered no advantage",
